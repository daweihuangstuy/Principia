public class Catalog {   
    ...
    public TopicTree constructTree() {
        ...
        TopicTree _06 = new TopicTree("6 Temperature and Heat");
        TopicTree _07 = new TopicTree("7 Electromagnetism");
        TopicTree _08 = new TopicTree("8 Light and Optics");
        ...
        _05.addChildren(_050, _051, _052);
        ...
        _06.addChildren(_060, _061, _062);

        TopicTree _070 = new TopicTree("0 Electrostatics");
        TopicTree _071 = new TopicTree("1 Magnetism");;
        TopicTree _072 = new TopicTree("2 Currents");
        _07.addChildren(_070, _071, _072);

        TopicTree _080 = new TopicTree("0 Electromagnetic Spectrum");
        TopicTree _081 = new TopicTree("1 Refraction");
        TopicTree _082 = new TopicTree("2 Diffraction");
        _08.addChildren(_080, _081, _082);

        TopicTree _090 = new TopicTree("0 Relativity");
        TopicTree _091 = new TopicTree("1 Photons");
        TopicTree _092 = new TopicTree("2 Radioactivity");
        _09.addChildren(_090, _091, _092);
